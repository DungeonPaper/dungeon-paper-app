...
Future<void> awaitConfirmation(
    Future<bool> confirmation, void Function() callback) async {
...
abstract class ConfirmationDialog<Options> {
  ...
  Future<void> confirm<T>(
      BuildContext context, Options options, void Function() onSuccess) {
    return _awaitConfirmation(
        _createConfirmation<T>(context, options), onSuccess);
  }
