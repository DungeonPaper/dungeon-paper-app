...
class MarkdownStyles {
  static of(BuildContext context) {
    ...
    return mdTheme.copyWith(
      ...
      h4: _headingTheme(textTheme.headlineMedium!, mdTheme.h4!,
          textScaleFactor: 0.93),
      h5: _headingTheme(textTheme.headlineSmall!, mdTheme.h5!,
          textScaleFactor: 0.88),
      h6: _headingTheme(textTheme.titleLarge!, mdTheme.h6!,
          textScaleFactor: 0.8),
      blockquotePadding:
