...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m22(hp, load, damageDice) =>
      "Base HP: ${hp}, Load: ${load}, Damage Dice: ${damageDice}";

  static String m23(moves, spells) =>
