...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m0(stat) => "Roll +${stat}";

  static m1(modifier) => "Modifier:\n${modifier}";

  static m2(year) => "Copyright © 2018-${year}";

  static m3(version) => "Version ${version}";

  static m4(coins) => "${coins} G";

  static m5(load, maxLoad) => "Load: ${load}/${maxLoad}";

  static m6(entity) => "Add New ${entity}";

  static m7(entity) => "Add Existing ${entity}";

  static m8(entity) => "Add ${entity}";

  static m9(alignment) => "${Intl.select(alignment, {'chaotic': 'Chaotic', 'evil': 'Evil', 'good': 'Good', 'lawful': 'Lawful', 'neutral': 'Neutral', 'other': '${alignment}', })}";

  static m10(entity) => "All ${entity}";

  static m11(entity) => "Change ${entity}";

  static m12(level, charClass, race) => "Level ${level} ∙ ${charClass} ∙ ${race} ∙";

  static m13(alignment) => "${alignment}";

  static m14(charClass) => "${charClass}";

  static m15(level) => "Level ${level}";

  static m16(race) => "${race}";

  static m17(count, fmtCount) => "${Intl.plural(count, zero: 'No coins', one: 'One coin', other: '${fmtCount} coins')}";

  static m18(entity, name) => "Are you sure you want to remove the ${entity} \"${name}\" from the list?";

  static m19(entity) => "Delete ${entity}?";

  static m20(provider) => "Are you sure you want to unlink your account from ${provider}?\nBy clicking \"Unlink\", you will no longer be able to sign in with ${provider}.\n\nYou will be able to re-link your account at any time by going to your account settings.";

  static m21(entity) => "Unlink from ${entity}?";

  static m22(hp, load, damageDice) => "Base HP: ${hp}, Load: ${load}, Damage Dice: ${damageDice}";

  static m23(moves, spells) => "${moves} Moves, ${spells} Spells selected";

  static m24(hp) => "Max HP: ${hp}";

  static m25(count) => "${count} selected";

  static m26(count, max) => "${count} selected (class allowance: ${max})";

  static m27(amount) => "${amount} coins";

  static m28(amount, name) => "${amount} × ${name}";

  static m29(step) => "${step} - Changes Required";

  static m30(cls) => "Level 1 ${cls}";

  static m31(entity) => "Create ${entity}";

  static m32(name, key) => "${name} (${key})";

  static m33(dice) => "Suggested: ${dice}";

  static m34(name, key) => "${name} (${key})";

  static m35(entity) => "Edit ${entity}";

  static m36(runtimeType) => "${Intl.select(runtimeType, {'CharacterClass': 'Class', 'Item': 'Item', 'Monster': 'Monster', 'Move': 'Move', 'Race': 'Race', 'Spell': 'Spell', 'Tag': 'Tag', 'MoveCategory': 'Category', 'GearSelection': 'Starting Gear', 'Dice': 'Dice', 'AbilityScore': 'Ability Score', 'AlignmentValue': 'Alignment', 'Playbook': 'Playbook', 'other': '${runtimeType}', })}";

  static m37(runtimeType) => "${Intl.select(runtimeType, {'CharacterClass': 'Classes', 'Item': 'Items', 'Monster': 'Monsters', 'Move': 'Moves', 'Race': 'Races', 'Spell': 'Spells', 'Tag': 'Tags', 'MoveCategory': 'Categories', 'Dice': 'Dice', 'GearSelection': 'Starting Gear', 'AbilityScore': 'Ability Scores', 'AlignmentValue': 'Alignment', 'Playbook': 'Playbooks', 'other': '${runtimeType}s', })}";

  static m38(entity) => "This ${entity} is not linked to any library item";

  static m39(entity) => "This ${entity} is In Sync with its linked library item";

  static m40(entity) => "This ${entity} is Out of Sync with its linked library item";

  static m41(count, entPlural, ent) => "${Intl.plural(count, zero: 'No ${entPlural}', one: 'One ${ent}', other: '${count} ${entPlural}')}";

  static m42(length) => "Must be exactly ${length} {length, plural, one character other characters}";

  static m43(length) => "Must be no more than ${length} {length, plural, one character other characters}";

  static m44(length) => "Must be at least ${length} {length, plural, one character other characters}";

  static m45(pattern) => "Must contain ${pattern}";

  static m46(pattern) => "Must not contain ${pattern}";

  static m47(entity) => "No ${entity} selected";

  static m48(entity) => "No ${entity} selected (required)";

  static m49(entity) => "${entity} category";

  static m50(entity) => "${entity} description";

  static m51(entity) => "${entity} explanation";

  static m52(entity) => "${entity} name";

  static m53(entity) => "${entity} title";

  static m54(n) => "Cell ${n}";

  static m55(n) => "Header ${n}";

  static m56(n) => "Header ${n}";

  static m57(n) => "Heading ${n}";

  static m58(entity) => "${entity} description";

  static m59(entity) => "${entity} name";

  static m60(entity) => "${entity} value";

  static m61(amount) => "Heal\n+${amount}";

  static m62(amount) => "Damage\n-${amount}";

  static m63(entity) => "Processing ${entity}...";

  static m64(amount) => "× ${amount}";

  static m65(count) => "${Intl.plural(count, zero: 'No items', one: 'One item', other: '${count} items')}";

  static m66(count, type) => "${count} in ${type}";

  static m67(type) => "${Intl.select(type, {'builtIn': 'Playbook', 'my': 'My Library', 'other': '${type}', })}";

  static m68(entities) => "Try changing the search or filters to find more ${entities}.";

  static m69(entities) => "No ${entities} found in this list.";

  static m70(entities) => "No ${entities} found";

  static m71(category) => "${Intl.select(category, {'starting': 'Starting', 'basic': 'Basic', 'special': 'Special', 'advanced1': 'Advanced', 'advanced2': 'Advanced', 'other': 'Other', })}";

  static m72(category) => "${Intl.select(category, {'starting': 'Starting', 'basic': 'Basic', 'special': 'Special', 'advanced1': 'Advanced (level 1-5)', 'advanced2': 'Advanced (level 6-10)', 'other': 'Other', })}";

  static m73(category) => "${Intl.select(category, {'starting': 'Starting', 'basic': 'Basic', 'special': 'Special', 'advanced1': 'Advanced (1-5)', 'advanced2': 'Advanced (6-10)', 'other': 'Other', })}";

  static m74(entity) => "Move ${entity} to bottom";

  static m75(entity) => "Move ${entity} to top";

  static m76(count) => "${Intl.plural(count, zero: 'No moves', one: 'One move', other: '${count} moves')}";

  static m77(entity) => "My ${entity}";

  static m78(entity) => "No ${entity}";

  static m79(count) => "${Intl.plural(count, zero: 'No notes', one: 'One note', other: '${count} notes')}";

  static m80(count, singular, plural) => "${Intl.plural(count, one: 'One ${singular}', other: '${count} ${plural}')}";

  static m81(dice) => "Roll ${dice}";

  static m82(dice) => "Roll ${dice}\n* Rolling with debility";

  static m83(dice, mod) => "Dice: ${dice} | Modifier: ${mod}";

  static m84(total) => "Total: ${total}";

  static m85(total) => "Total: ${total}";

  static m86(count) => "Rolling ${count} dice";

  static m87(entity) => "Save ${entity}";

  static m88(entity) => "Type to search ${entity}";

  static m89(entity) => "Select ${entity}";

  static m90(string) => "Select ${string} to add";

  static m91(provider) => "This device only supports unlinking ${provider} accounts.";

  static m92(provider) => "You may only unlink ${provider} from this device.\nTo link accounts using the ${provider} provider is only available from supported devices.";

  static m93(provider) => "${Intl.select(provider, {'facebook': 'Facebook', 'google': 'Google', 'apple': 'Apple', 'password': 'Dungeon Paper', 'other': 'Other', })}";

  static m94(provider) => "Sign in with ${provider}";

  static m95(length) => "Password must be at least ${length} characters";

  static m96(pattern) => "Password must contain ${pattern}";

  static m97(length) => "Username must be at least ${length} characters";

  static m98(provider) => "Sign up with ${provider}";

  static m99(button) => "${Intl.select(button, {'damage': 'Damage', 'other': '${button}', })}";

  static m100(level) => "${Intl.select(level, {'cantrip': 'Cantrip', 'rote': 'Rote', 'other': 'Level ${level}', })}";

  static m101(count) => "${Intl.plural(count, zero: 'No spells', one: 'One spell', other: '${count} spells')}";

  static m102(tag) => "Copy from: ${tag}";

  static m103(entity) => "View ${entity}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function> {
    ...
    "abilityScoreBondDescription" : MessageLookupByLibrary.simpleMessage("When a move has you roll+BOND you\'ll count the number of bonds you have with the character in question and add that to the roll."),
    "abilityScoreBondName" : MessageLookupByLibrary.simpleMessage("Charisma"),
    "abilityScoreButtonTooltip" : m0,
    "abilityScoreChaDebilityDescription" : MessageLookupByLibrary.simpleMessage("It may not be permanent, but for now you don\'t look so good."),
    "abilityScoreChaDebilityName" : MessageLookupByLibrary.simpleMessage("Scarred"),
    "abilityScoreChaDescription" : MessageLookupByLibrary.simpleMessage("Measures a character\'s personality, personal magnetism, ability to lead, and appearance."),
    "abilityScoreChaName" : MessageLookupByLibrary.simpleMessage("Charisma"),
    "abilityScoreConDebilityDescription" : MessageLookupByLibrary.simpleMessage("Something just isn\'t right inside. Maybe you\'ve got a disease or a wasting illness. Maybe you just drank too much ale last night and it\'s coming back to haunt you."),
    "abilityScoreConDebilityName" : MessageLookupByLibrary.simpleMessage("Sick"),
    "abilityScoreConDescription" : MessageLookupByLibrary.simpleMessage("Represents your character\'s health and stamina."),
    "abilityScoreConName" : MessageLookupByLibrary.simpleMessage("Constitution"),
    "abilityScoreDexDebilityDescription" : MessageLookupByLibrary.simpleMessage("You\'re unsteady on your feet and you\'ve got a shake in your hands."),
    ...
    "abilityScoreFormDebilityDescriptionDescription" : MessageLookupByLibrary.simpleMessage("A description of the effect causing the debility and/or how it affects your character"),
    "abilityScoreFormDebilityDescriptionLabel" : MessageLookupByLibrary.simpleMessage("Debility Description"),
    "abilityScoreFormDebilityNameDescription" : MessageLookupByLibrary.simpleMessage("The name for the debility that occurs when this stat is debilitated (takes -1 until recovered)."),
    "abilityScoreFormDebilityNameLabel" : MessageLookupByLibrary.simpleMessage("Debility Name"),
    "abilityScoreFormDescriptionDescription" : MessageLookupByLibrary.simpleMessage("A description of what this ability score represents"),
    ...
    "abilityScoreFormKeyDescription" : MessageLookupByLibrary.simpleMessage("A 3-letter unique key that identifies this ability score in dice and is used as the short label for the modifier value (and not the actual score)"),
    ...
    "abilityScoreInfo" : MessageLookupByLibrary.simpleMessage("You can drag & drop the stat cards to change the order in which they appear throughout this character\'s screens."),
    "abilityScoreIntDebilityDescription" : MessageLookupByLibrary.simpleMessage("That last knock to the head shook something loose. Brain not work so good."),
    "abilityScoreIntDebilityName" : MessageLookupByLibrary.simpleMessage("Stunned"),
    "abilityScoreIntDescription" : MessageLookupByLibrary.simpleMessage("Determines how well your character learns and reasons."),
    ...
    "abilityScoreStrDebilityDescription" : MessageLookupByLibrary.simpleMessage("You can\'t exert much force. Maybe it\'s just fatigue and injury, or maybe your strength was drained by magic."),
    ...
    "abilityScoreWisDebilityDescription" : MessageLookupByLibrary.simpleMessage("Ears ringing. Vision blurred. You\'re more than a little out of it."),
    "abilityScoreWisDebilityName" : MessageLookupByLibrary.simpleMessage("Confused"),
    "abilityScoreWisDescription" : MessageLookupByLibrary.simpleMessage("Describes a character\'s willpower, common sense, awareness, and intuition."),
    ...
    "aboutJoinDiscordSubtitle" : MessageLookupByLibrary.simpleMessage("Join the Discord community to ask questions, get help, send feedback, or just chat with other players."),
    "aboutSendFeedback" : MessageLookupByLibrary.simpleMessage("Send Feedback"),
    "aboutSendFeedbackSubtitle" : MessageLookupByLibrary.simpleMessage("We reply more promptly through Discord, but you can send us feedback, bug reports or suggestions about the app directly here as an alternative."),
    ...
    "basicInfoImageNeedAccountPrefix" : MessageLookupByLibrary.simpleMessage("You need to be signed in to upload images."),
    "basicInfoImageNeedAccountSuffix" : MessageLookupByLibrary.simpleMessage(", or upload using your own URL below."),
    ...
    "characterBioDialogAlignmentDescriptionPlaceholder" : MessageLookupByLibrary.simpleMessage("Alignment is your character\'s way of thinking and moral compass. This can center on an ethical ideal, religious strictures or early life events. It reflects what your character values and aspires to protect or create."),
    ...
    "characterBioDialogDescPlaceholder" : MessageLookupByLibrary.simpleMessage("Describe your character\'s background, personality, goals, etc."),
    "characterBioDialogLooksLabel" : MessageLookupByLibrary.simpleMessage("Looks"),
    "characterBioDialogLooksPlaceholder" : MessageLookupByLibrary.simpleMessage("Describe your character\'s appearance. You may use the presets from the buttons above."),
    ...
    "characterBondsFlagsDialogInfoText" : MessageLookupByLibrary.simpleMessage("You can add, update or remove bonds & flags using the edit icon above."),
    "characterBondsFlagsDialogNoData" : MessageLookupByLibrary.simpleMessage("You have no bonds or flags. You can add some using the edit button above, then mark them off as completed as you go along your adventure."),
    "characterBondsFlagsDialogTitle" : MessageLookupByLibrary.simpleMessage("Bonds & Flags"),
    "characterDebilitiesDialogInfoText" : MessageLookupByLibrary.simpleMessage("Debilities are temporary, negative conditions or states in which your character is in. When a stat is debilitated, it causes its modifier to be reduced by 1 until recovered."),
    ...
    "confirmDeleteAccount1Body" : MessageLookupByLibrary.simpleMessage("Are you sure you want to delete your account?\n\nThis action cannot be undone."),
    "confirmDeleteAccount1Title" : MessageLookupByLibrary.simpleMessage("Delete Your Account?"),
    "confirmDeleteAccount2Body" : MessageLookupByLibrary.simpleMessage("We do not save any data for deleted accounts. All your data will be permanently deleted.\n\nAre you sure you want to delete your account?\n\nPlease confirm this one last time."),
    ...
    "confirmExitDefaultText" : MessageLookupByLibrary.simpleMessage("Going back will lose any unsaved changes.\nAre you sure you want to go back?"),
    ...
    "createCharacterBioFieldPlaceholder" : MessageLookupByLibrary.simpleMessage("Describe your character as shortly or thoroughly as you want here.\nPut your backstory, a visual description, some personality traits, etc. to help you keep in character."),
    ...
    "createCharacterDescFieldPlaceholder" : MessageLookupByLibrary.simpleMessage("Enter general information about your character - backstory, goals & ambitions, behavior descriptions, etc"),
    ...
    "createCharacterRaceDescFieldPlaceholder" : MessageLookupByLibrary.simpleMessage("Describe a special move usable by your race. It will appear alongside the rest of the moves."),
    ...
    "createCharacterStartingGearHelpText" : MessageLookupByLibrary.simpleMessage("Select your starting gear determined by class (optional)"),
    ...
    "editGeneric" : m35,
    "endOfSessionQ1" : MessageLookupByLibrary.simpleMessage("Did we learn something new and important about the world?"),
    ...
    "endOfSessionQuestionsSubtitle" : MessageLookupByLibrary.simpleMessage("Answer these questions as a group. For each \"yes\" answer, XP is marked."),
    "entity" : m36,
    "entityPlural" : m37,
    ...
    "errorUpload" : MessageLookupByLibrary.simpleMessage("Error while uploading photo. Try again later, or contact support using the \"About\" page."),
    ...
    "exportFailedMessage" : MessageLookupByLibrary.simpleMessage("Something went wrong.\nTry again or contact support if this persists"),
    ...
    "formCharacterClassDescriptionPlaceholder" : MessageLookupByLibrary.simpleMessage("Give a general description of your class. Describe a calling for the type of person or creature that would choose or be raised in to this adventuring profession."),
    ...
    "homeEmptyStateLoginSubtitle" : MessageLookupByLibrary.simpleMessage("Online data sync, library sharing, campaigns and more!"),
    ...
    "migrationSubtitle" : MessageLookupByLibrary.simpleMessage("To get started, pick a username and the language for the rulebook & app. If you already have an existing Dungeon Paper account your data might take a few seconds to migrate."),
    "migrationTitle" : MessageLookupByLibrary.simpleMessage("Welcome to\nDungeon Paper 2!"),
    "migrationUsernameInfo" : MessageLookupByLibrary.simpleMessage("Your username is unique and can not be changed later, so think carefully! It will be used to identify all your library items when publishing."),
    "moveCategory" : m71,
    ...
    "sendFeedbackSuccessMessage" : MessageLookupByLibrary.simpleMessage("Thank you for your feedback! We will review your feedback as soon as we can."),
    ...
    "signinSubtitle" : MessageLookupByLibrary.simpleMessage("Sign in to your account to sync your data online, and get access to many more features."),
    ...
    "signupPasswordValidationPatternLetter" : MessageLookupByLibrary.simpleMessage("Password must contain at least one capital letter"),
    "signupPasswordValidationPatternNumber" : MessageLookupByLibrary.simpleMessage("Password must contain at least one number"),
    "signupSubtitle" : MessageLookupByLibrary.simpleMessage("Enter the required details below to create your Dungeon Paper account."),
    ...
    "signupUsernameValidationPattern" : MessageLookupByLibrary.simpleMessage("Username must only contain letters, numbers, dashes and underscores"),
    ...
    "xpDialogOverrideInfoText" : MessageLookupByLibrary.simpleMessage("Changing the current XP or level manually will cause the pending XP to be discarded unless this is unchecked."),
    ...
    "xpDialogResetSessionMarks" : MessageLookupByLibrary.simpleMessage("Reset bonds, flags & end of session questions after saving"),
