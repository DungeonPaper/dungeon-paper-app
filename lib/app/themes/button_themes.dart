...
class ButtonThemes {
  ...
  static ButtonStyle? primaryElevated(BuildContext context, {double? backgroundOpacity}) => ElevatedButton.styleFrom();
  ...
  static ButtonStyle? errorOutlined(BuildContext context) => OutlinedButton.styleFrom(
        foregroundColor: Theme.of(context).colorScheme.onError,
