...
TextTheme copyTextThemeWith(
  ...
  Color? specialColor,
    ...
    original.copyWith(
      displayLarge: original.displayLarge
          ?.copyWith(fontFamily: fontFamily, color: specialColor),
      displayMedium: original.displayMedium
          ?.copyWith(fontFamily: fontFamily, color: specialColor),
      displaySmall: original.displaySmall
          ?.copyWith(fontFamily: fontFamily, color: specialColor),
      headlineMedium: original.headlineMedium
          ?.copyWith(fontFamily: fontFamily, color: specialColor),
      headlineSmall: original.headlineSmall
          ?.copyWith(fontFamily: fontFamily, color: specialColor),
      titleLarge: original.titleLarge
          ?.copyWith(fontFamily: fontFamily, color: specialColor),
      titleMedium: original.titleMedium
          ?.copyWith(fontFamily: fontFamily, color: specialColor),
      titleSmall: original.titleSmall
          ?.copyWith(fontFamily: fontFamily, color: specialColor),
      bodyLarge: original.bodyLarge
          ?.copyWith(fontFamily: fontFamily, color: normalColor),
      bodyMedium: original.bodyMedium
          ?.copyWith(fontFamily: fontFamily, color: normalColor),
      bodySmall: original.bodySmall
          ?.copyWith(fontFamily: fontFamily, color: normalColor),
      labelLarge: original.labelLarge
          ?.copyWith(fontFamily: fontFamily, color: normalColor),
      labelSmall: original.labelSmall
          ?.copyWith(fontFamily: fontFamily, color: normalColor),
    );
...
ColorScheme createColorScheme(
  ...
  return ColorScheme.fromSeed(
    ...
    primary: primary,
    secondary: secondary,
    onSecondary: ThemeData.estimateBrightnessForColor(
                secondary ?? defaultBase.secondary) ==
            Brightness.light
        ? Colors.black
        : Colors.white,
  );
...
ThemeData createTheme(
  ...
  final textTheme =
      brightness == Brightness.light ? lightM3.textTheme : darkM3.textTheme;
  ...
  return base.copyWith(
    ...
    tabBarTheme: base.tabBarTheme.copyWith(
      ...
      unselectedLabelStyle:
          base.textTheme.bodyMedium!.copyWith(fontFamily: 'Nunito'),
