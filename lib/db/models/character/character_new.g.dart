...
_$_CharacterNew _$_$_CharacterNewFromJson(Map<String, dynamic> json) {
  return _$_CharacterNew(
    ...
    inventory: (json['inventory'] as List)
        ...
        ?.toList(),
    hitDice: const DiceConverter().fromJson(json['hitDice']),
...
Map<String, dynamic> _$_$_CharacterNewToJson(_$_CharacterNew instance) =>
    <String, dynamic>{
      ...
      'inventory': instance.inventory
          ...
          ?.toList(),
      'hitDice': const DiceConverter().toJson(instance.hitDice),
